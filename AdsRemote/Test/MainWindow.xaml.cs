...
namespace Test
{
    public partial class MainWindow : Window
    {
        ...
        public const string PLC_AMSNETID = "192.168.0.200.1.1";
        ViewModel model;
        ...
        public MainWindow()
        {
            ...
            var cx9020 = new PLC(PLC_AMSNETID);

            model = cx9020.Class<ViewModel>();
        ...
        private void Temp_ValueChanged(object sender, AdsRemote.Common.Var e)
        {
            ...
            if (gh > bh && gh < rh) score = score + 0.1;

            if (gh < bh) score = score - .01;
            ...
            else tempEllipse.StrokeThickness = (gh < bh ? 2 : (gh - bh) / 2) / scale / 2;

            score = Math.Max(0, score);

            scoreLabel.Content = $"SCORE: {(int)score}";

            if (model.Reset) model.Reset.RemoteValue = false;
        }
